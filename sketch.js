...
function setup() {
  ...
  ground = createSprite(displayWidth/2-200,180,400,20);
  ...
  invisibleGround = createSprite(200,190,displayWidth*10,10);
...
function spawnObstacles() {
  if(camera.position.x % 500 === 0) {
    var obstacle = createSprite(camera.position.x+displayWidth,165,10,40);
    //obstacle.debug = true;
